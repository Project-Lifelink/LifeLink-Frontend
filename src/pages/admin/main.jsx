...
const HospitalSidebar = () => {
    ...
    const menuItems = [
        ...
        { name: "Hospital", icon: History, link: "hospitals" },
        { name: "Users", icon: ShieldCheck, link: "users" },
        // { name: "", icon: CircleHelp, link: "helpandsupport" },
                ...
                {!collapsed && (
                    <div className="border-t border-line p-4">
                        <div className="flex items-center gap-3 rounded-2xl border border-line bg-canvas p-4">
                            ...
                            <div>
                                <h3 className="text-sm font-semibold text-ink">Admin Panel</h3>
